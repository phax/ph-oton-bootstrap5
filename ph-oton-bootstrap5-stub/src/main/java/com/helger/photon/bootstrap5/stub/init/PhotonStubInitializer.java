 ...
 */
package com.helger.photon.bootstrap5.stub.init;
...
import com.helger.photon.bootstrap5.BootstrapCustomConfig;
...
public final class PhotonStubInitializer
{
  ...
  public static void registerDefaultResources ()
  {
    ...
    PhotonMetaElements.registerMetaElementForGlobal (EStandardMetaElement.VIEWPORT.getAsMetaElement ("width=device-width, initial-scale=1"));
