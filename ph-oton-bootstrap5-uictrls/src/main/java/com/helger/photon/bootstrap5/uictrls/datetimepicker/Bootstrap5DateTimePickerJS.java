 ...
 */
@OutOfBandNode
@SpecialNodeListModifier (Bootstrap5DateTimePickerSpecialNodeListModifier.class)
public class Bootstrap5DateTimePickerJS extends AbstractHCScriptInline <Bootstrap5DateTimePickerJS>
{
