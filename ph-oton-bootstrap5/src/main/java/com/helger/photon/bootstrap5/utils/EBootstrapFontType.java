...
{
  BOLD (CBootstrapCSS.FW_BOLD),
  NORMAL (CBootstrapCSS.FW_NORMAL),
  LIGHT (CBootstrapCSS.FW_LIGHT),
  ITALIC (CBootstrapCSS.FST_ITALIC),
  MONOSPACE (CBootstrapCSS.FONT_MONOSPACE);
